...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\linewidth}{|X||X|X|X|}\hline
        %Sensor                                 & Maximum distance (remission) & Echoes     & Spot Shape \\ \hline%\hline
        %Velodyne HDL-32E~\cite{VelodyneManual} & \siunitx{70}{meter}(max)     & 1          & Rectangle  \\ \hline
        %Hokuyo UTM-30LX-EW~\cite{UTMDatasheet} & \siunitx{30}{meter}(max)     & 3          & Ellipse    \\ \hline
        %SICK LMS151~\cite{LMS151Datasheet}     & \siunitx{50}{meter}(gt75)    & 1 (second) & Circle     \\ \hline
        %SICK LMS200~\cite{LMS200Datasheet}     & \siunitx{28}{meter}(gt75)    & 1          & Circle     \\ \hline
    \end{tabularx}
